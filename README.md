...
to browse on an iPad. A sibling of [Wcupedia](https://github.com/masarusz/wcupedia).

**Live site:** https://masarusz.github.io/clubpedia/ (not yet published)

A static site: no accounts, no tracking, no server.

> Status: in development. The data sources have been chosen; the data pipeline
> is next.
...
See [DATA-LICENSE.md](DATA-LICENSE.md). Club crests and league logos are not
used. Code is MIT — see [LICENSE](LICENSE).
